package model.fitness.practice2;
...
public class FunctionTSP extends Function {
	...
	private static String[] cityName = {"Albacete", "Alicante", "Almeria", "Ã�vila", "Badajoz", "Barcelona", "Bilbao", "Burgos", "CÃ¡ceres",
			"Cádiz", "Castellón", "Ciudad Real", "CÃ³rdoba", "A CoruÃ±a", "Cuenca", "Gerona", "Granada", "Guadalajara", "Huelva", 
			"Huesca", "JaÃ©n", "LeÃ³n", "LÃ©rida", "LogroÃ±o", "Lugo", "Madrid", "Málaga", "Murcia"};
