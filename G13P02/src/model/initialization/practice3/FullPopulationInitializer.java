...
public class FullPopulationInitializer extends BinaryTreePopulationInitializer {
	...
	public FullPopulationInitializer(MoldI mold, int maxDepth, int populationAmount, TreeMutationI mutationMethod) {
	...
	public List<TreeChromosome> initialize() {
		...
		for (int i = 0; i < populationAmount; i++)
			population.add(new FullInitializer(mold, maxDepth, mutationMethod).initialize());
		return population;
	}
}
